package com.wwflgames.fury.gamestate.title;
...
public class TitleGameState extends BasicGameState {
    ...
    public TitleGameState(ProfessionFactory professionFactory, PlayerFactory playerFactory,
        ...
        DungeonMapCreator newCreator = new NewDungeonMapCreator();
        dungeonCreator = new DungeonCreatorImpl(newCreator, monsterFactory,appState);
